...
const Navbar = () => {
  ...
  return (
    <nav className="md:bg-transparent sticky top-0 z-50 bg-black">
      <div
      ...
      >
        ...
        <motion.div
          ...
          className={`${isMenuOpen ? "block" : "hidden"} w-full md:block md:w-auto p-2 md:rounded-full md:shadow-md md:shadow-[#6c63ff] bg-black rounded-3xl sm:border-solid border-2 border-[#6c63ff] md:border-none`}
          id="navbar-default"
        >
